// part_id: e4_alt
// name: E4 alternate gear
// source_drawing_ids: DRW-004
// units: mm
// SPDX-License-Identifier: MIT
//
// Part E4_alt: annular e4 variant from the later DRW-004 sheet.
//
...
function e4_alt_polar(r, a_deg) = [r * cos(a_deg), r * sin(a_deg)];

module e4_alt_tooth_gap_2d(
    outer_r = 50.19,
    root_r = 49.77,
    pitch_deg = 360 / 250,
    tip_land_deg = 0.36,
    ...
    polygon(points = [
        e4_alt_polar(outer_r + overshoot_r, -gap_half_deg),
        e4_alt_polar(shoulder_r, -shoulder_deg),
        e4_alt_polar(throat_r, -throat_deg),
        e4_alt_polar(root_r, -root_deg),
        e4_alt_polar(root_r, root_deg),
        e4_alt_polar(throat_r, throat_deg),
        e4_alt_polar(shoulder_r, shoulder_deg),
        e4_alt_polar(outer_r + overshoot_r, gap_half_deg)
