...
module drw001_sheet5() {
    ...
    if (show_ortho) {
        ...
        color("black") translate([130, 165, 0.01]) linear_extrude(height = th) projection(cut = false) part_a2();
        color("black") translate([150, 216, 0]) linear_extrude(height = th) label("a2", sz = 3.1, bold = true);

        color([0.90, 0.90, 0.90]) translate([206, 164, 0]) linear_extrude(height = th) projection(cut = false) part_a3();
        color("black") translate([206, 164, 0.01]) linear_extrude(height = th) projection(cut = false) part_a3();
        color("black") translate([214, 227, 0]) linear_extrude(height = th) label("a3", sz = 3.1, bold = true);

        color([0.90, 0.90, 0.90]) translate([310, 160, 0]) linear_extrude(height = th) projection(cut = false) part_a4();
        color("black") translate([310, 160, 0.01]) linear_extrude(height = th) projection(cut = false) part_a4();
        color("black") translate([324, 198, 0]) linear_extrude(height = th) label("a4", sz = 3.1, bold = true);

        color([0.90, 0.90, 0.90]) translate([130, 72, 0]) linear_extrude(height = th) projection(cut = false) part_a5();
        color("black") translate([130, 72, 0.01]) linear_extrude(height = th) projection(cut = false) part_a5();
        color("black") translate([138, 95, 0]) linear_extrude(height = th) label("a5", sz = 3.1, bold = true);

        color([0.90, 0.90, 0.90]) translate([311, 73, 0]) linear_extrude(height = th) projection(cut = false) part_a6();
        color("black") translate([311, 73, 0.01]) linear_extrude(height = th) projection(cut = false) part_a6();
        color("black") translate([332, 126, 0]) linear_extrude(height = th) label("a6", sz = 3.1, bold = true);

        color([0.90, 0.90, 0.90]) translate([226, 72, 0]) linear_extrude(height = th) a12_profile_2d();
        color("black") translate([226, 72, 0.01]) linear_extrude(height = th) a12_profile_2d();
