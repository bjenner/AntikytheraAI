...
- `ref/meta/drawing_index.csv` has correct `scad_status` and ordered `scad_sheets_done` for `DRW-001`.
- `ref/meta/parts_list.csv` entries for Drawing 1 parts contain stable IDs and `scad_file` evidence.
