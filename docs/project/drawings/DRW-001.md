...
| `a3` | `scad/parts/a3_pin.scad` | `d=9.8`, `h=15` |
| `a4` | `scad/parts/a4_block.scad` | `w=16`, `d=8`, `h=24`, `bore_d=10.0` |
...
- `a3` is currently a placeholder and does not match DRW-001 Sheet 5 detail geometry.
- `a3` missing/incorrect items to address: keyed/lobed top profile (`R2.5`/`R1.0`), lower slot/split section (`3.0` region), `Ø1.5` cross-hole, and detailed stacked heights.
